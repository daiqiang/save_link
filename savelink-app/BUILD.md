...
| 1.4 | 代强 | 2026-08-15 | 统一 v0.4.0 绿色版、安装包产物和发布标签示例 |
| 1.5 | Codex | 2026-08-31 | 准备发布 v0.5.0，更新绿色版、安装包产物和发布标签示例 |
| 1.6 | Codex | 2026-09-05 | 准备发布 v0.5.1，统一应用版本、发布产物和标签示例 |
...
src-tauri/target/release/bundle/portable/SaveLink_0.5.1_windows_x64_portable.zip
src-tauri/target/release/bundle/portable/SaveLink_0.5.1_windows_x64_portable.zip.sha256.txt
src-tauri/target/release/bundle/nsis/SaveLink_0.5.1_x64-setup.exe
src-tauri/target/release/bundle/msi/SaveLink_0.5.1_x64_en-US.msi
```
...
1. `git status` 必须干净。
2. 发布标签必须指向准备打包的提交，例如 `git rev-list -n 1 v0.5.1` 与当前 `HEAD` 一致。
