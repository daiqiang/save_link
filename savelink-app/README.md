...
| 1.7 | Codex | 2026-08-29 | 增加快照普通区/锁定区显示编号、待整理状态和独立维护周期说明 |
...
- 时间线将锁定区置顶，普通快照显示“存档1、存档2……”并按最新在前编号，锁定快照单独显示“锁定存档1、锁定存档2……”。锁定/解锁后会先显示“待整理”，每 10 分钟统一调整区域；关闭自动备份只停止自动创建，不停止整理和清理。
