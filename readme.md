...
| 版本 | 修改人 | 时间 | 备注 |
| --- | --- | --- | --- |
| 1.0 | 代强 | 2026-08-06 | 按飞书 README 同步 v0.2.0 下载、自动上传、存档保留、页面截图和后续计划 |
...
前往 [GitHub Releases](https://github.com/daiqiang/save_link/releases) 下载最新版本。当前版本为 [v0.2.0](https://github.com/daiqiang/save_link/releases/tag/v0.2.0)。
