...
| 1.9 | Codex | 2026-09-03 | 同步 v0.6.0 五轮评审修订：远端存在性使用新鲜结果，真实账号与请求级 generation 双重隔离，并为永久墓碑增加点查门槛；实现前仍保持 v0.5.0 行为 |
