...
> 最后更新：2026-08-05（v0.2.0 主流程已完成专项验收，时间格式修复待设备 B 复验）
...
- `savelink-app`：Tauri 自动上传状态选择测试 2 个全绿，React `npm run build` 通过；v0.2.0 本地专项及真实百度上传、跨 profile 下载恢复、联合删除主流程已验收。时间格式修复仍需重新打绿色版并做设备 B 轻量复验。开发包仍显示 0.1.0，不要上传覆盖公开 Release。
